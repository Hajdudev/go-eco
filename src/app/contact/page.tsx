                ...
                <form onSubmit={handleSubmit} className='space-y-6'>
                  ...
                  <div>
                    <button
                      type='submit'
                      disabled={isLoading}
                      className={`bg-primary hover:bg-primary-dark focus:ring-primary inline-flex w-full justify-center rounded-md border border-transparent px-4 py-3 text-sm font-medium text-white shadow-sm focus:ring-2 focus:ring-offset-2 focus:outline-none ${isLoading ? 'cursor-not-allowed opacity-75' : ''}`}
                    ></button>
                    {isLoading ? (
                      <>
                        <svg
